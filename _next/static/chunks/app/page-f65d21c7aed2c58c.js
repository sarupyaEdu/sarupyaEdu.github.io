  ...
  [974],
  {
    ...
    2324: (e, t, a) => {
      ...
      var y = a(8150),
        ...
        j = a(7828),
        k = a(9926);
      let N = (0, n.A)("monitor-smartphone", [
        [
          "path",
          {
      ...
      let I = [
          ...
          },
          {
            ...
            icon: g,
            items: [
              { name: "Vite", level: 85, icon: y.A },
              { name: "Axios", level: 85, icon: w.A },
              { name: "Postman", level: 80, icon: w.A },
              { name: "React Toastify", level: 78, icon: v.A },
              { name: "Git", level: 82, icon: d.A },
              { name: "VS Code", level: 90, icon: y.A },
            ],
          },
          {
            name: "UI & Design",
            ...
            items: [
              ...
              { name: "Responsive Design", level: 85, icon: N },
            ],
          },
          {
                    ...
                    children: [
                      (0, i.jsx)(s.P.div, {
                        ...
                        children: (0, i.jsx)("span", {
                          className:
                            "inline-block py-1.5 px-3 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[10px] sm:text-xs font-bold tracking-[0.18em] uppercase mb-5 sm:mb-6",
                          children:
                      ...
                      (0, i.jsxs)(s.P.h1, {
                        ...
                        className:
                          "text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-display font-bold tracking-tight mb-6 sm:mb-8 leading-[0.95] text-zinc-900 dark:text-white",
                        children: [
                          "Building ",
                          (0, i.jsx)("span", {
                          ...
                          " ",
                          "web experiences that feel as good as they perform.",
                        ],
                      }),
                      (0, i.jsx)(s.P.p, {
                        initial: { opacity: 0, y: 20 },
                        ...
                        className:
                          "text-base sm:text-lg md:text-xl mb-8 sm:mb-10 max-w-2xl text-zinc-600 dark:text-zinc-300 leading-relaxed",
                        children:
                          "I'm a Full-Stack Developer focused on creating responsive, scalable, and visually polished web applications. I enjoy turning ideas into real products through clean code, thoughtful design, and smooth user experiences.",
                      }),
                      (0, i.jsxs)(s.P.div, {
                        initial: { opacity: 0, y: 20 },
                        animate: { opacity: 1, y: 0 },
